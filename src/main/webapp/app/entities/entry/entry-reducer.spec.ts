...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './entry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTRY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTRY actions', async () => {
      const expectedActions = [
        {
