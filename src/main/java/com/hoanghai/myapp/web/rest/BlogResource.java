...
import com.hoanghai.myapp.domain.Blog;
import com.hoanghai.myapp.repository.BlogRepository;
import com.hoanghai.myapp.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.hoanghai.myapp.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
